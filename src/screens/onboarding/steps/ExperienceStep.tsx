      ...
      <div className="space-y-2">
        ...
        <div className="space-y-2">
          {EXPERIENCE_LEVELS.map((level) => (
            <Card
              key={level.value}
              className={`p-4 cursor-pointer transition-all ${watchedValues.experienceLevel === level.value
            ...
            >
              <div className="flex items-start space-x-3">
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all mt-0.5 ${watchedValues.experienceLevel === level.value
